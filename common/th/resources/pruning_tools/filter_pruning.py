        ...
        if self.opt.prune_all:
            for layer, (name, module) in enumerate(self.net.sfeb._modules.items()):
                if isinstance(module, torch.nn.modules.conv.Conv2d):
                    ...
                    if layer_index != 3 or (layer_index == 3 and module.out_channels > 48): # or [ layer_index == 0 and self.opt.prune_targets == [(0, 0)]]:
                        # print("layer_index",layer_index, "module.out_channels",module.out_channels, "self.opt.prune_targets",self.opt.prune_targets)
                        print("layer_index",layer_index, "module.out_channels",module.out_channels)
